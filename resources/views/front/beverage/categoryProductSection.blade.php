<section class="product-area product-6 pt-100 pb-75">
    <div class="container">
        <div class="row">
            <div class="col-12">
                                                            ...
                                                            <figure class="product-img mb-20 mx-auto">
                                                                ...
                                                                <div class="hover-show">
                                                                    <a href="{{ route('front.product.details', [$product->slug, $product->id]) }}"
                                                                        ...
                                                                        class="cart-link btn btn-md btn-primary"
                                                            ...
                                                            <div class="product-details">
                                                                ...
                                                                <div class="product-price">
                                                                    <span class="h6 font-lg new-price color-primary">
                                                                        {{ $be->base_currency_symbol_position == 'left' ? $be->base_currency_symbol : '' }}{{ convertUtf8($product->current_price) }}
                                                                        {{ $be->base_currency_symbol_position == 'right' ? $be->base_currency_symbol : '' }}
                                                                    </span>
                                                                    @if ($product->previous_price)
                                                                        <span
                                                                            class="prev-price font-sm">{{ $be->base_currency_symbol_position == 'left' ? $be->base_currency_symbol : '' }}{{ convertUtf8($product->previous_price) }}{{ $be->base_currency_symbol_position == 'right' ? $be->base_currency_symbol : '' }}</span>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            @if ($category->products()->where('is_feature', 1)->where('status', 1)->count() > 0)
                                <div class="cta-btn text-center mt-15 mb-25">
                                    <a href="{{ route('front.items', ['category_id' => $category->id]) }}"
                                        class="btn btn-lg btn-primary" title="{{ __('View All Items') }}"
