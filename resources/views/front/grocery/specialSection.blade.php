                    ...
                    <div class="col-md-6 col-lg-4 item">
                        <div class="product text-center radius-md mb-30 item">
                            <figure class="product-img">
                                <a href="{{ route('front.product.details', [$sproduct->slug, $sproduct->id]) }}" target="_self" title="Link"
                                    class="lazy-container ratio ratio-2-3 bg-none">
                                    <img class="lazyload" src="{{ asset('assets/front/img/product/featured/' . $sproduct->feature_image) }}"
                                        data-src="{{ asset('assets/front/img/product/featured/' . $sproduct->feature_image) }}" alt="Image">
                                </a>
                            </figure>
                            <div class="product-details p-30">
                                ...
                                <div class="mt-25">
                                    ...
                                    data-href="{{ route('add.cart', $sproduct->id) }}" href="{{ route('front.product.details', [$sproduct->slug, $sproduct->id]) }}" class="cart-link btn btn-lg btn-primary"
